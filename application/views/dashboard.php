        ...
        <table class="table">
            ...
            <tbody>
                ...
                foreach ($get as $g) : ?>
                    <tr>
                        <th scope="row"><?= $i++; ?></th>
                        <td><?= $g['nama_belajar']; ?></td>
                        <td><?= $g['alamat_belajar']; ?></td>
                        <td><img width="200" src="<?= base_url(); ?>assets/foto/<?= $g['foto']; ?>"> </td>
                        <td> <a href="<?= base_url(); ?>Admin/hapus/<?= $g['id']; ?>">Hapus</a>
                            <a href="<?= base_url(); ?>Admin/detail/<?= $g['id']; ?>">Detail</a>
                            <a href="<?= base_url(); ?>Admin/update/<?= $g['id']; ?>">Update</a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
